...
- ⏳ **Deferred (need a migration verified against Postgres + a decision):** a user-facing **"report this photo"** surface (premature — public contributions aren't open yet), and confirmation-level takedown with §4 consensus re-eval.
