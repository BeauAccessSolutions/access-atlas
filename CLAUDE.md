...
- ▶️ **Unblocks** the iOS App Review 4.2 camera value-add (§13 TestFlight track). ⏳ Photo **moderation** (abuse/off-topic images) is now a real surface — revisit before contributions open publicly.
